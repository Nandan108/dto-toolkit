...
enum ErrorMode: string
{
    ...
    /** Exceptions are recorded, and the property is omitted entirely:<br>- inbound: property is marked "unfilled"<br>- outbound: property does not appear in output arrays. */
