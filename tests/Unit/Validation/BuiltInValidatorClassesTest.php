...
final class BuiltInValidatorClassesTest extends TestCase
{
    ...
    public static function validatorProvider(): array
    {
        return [
            ...
            'date format invalid'                     => [V\DateFormat::class, ['Y-m-d'], '2025/99/99', 'processing.guard.invalid_value.date.format'],
            'date format non string'                  => [V\DateFormat::class, ['Y-m-d'], 123, 'processing.guard.invalid_value.date.format'],
            'date format valid'                       => [V\DateFormat::class, ['Y-m-d'], '2025-01-02'],
            'email invalid'                           => [V\Email::class, [], 'not-an-email', 'processing.guard.invalid_value.email'],
            'email valid'                             => [V\Email::class, [], 'test@example.com'],
            'json invalid'                            => [V\Json::class, [[]], '{bad', 'processing.guard.invalid_value.json'],
            'json valid'                              => [V\Json::class, [[]], '{"a":1}'],
            'json type mismatch'                      => [V\Json::class, [['object']], '"str"', 'processing.guard.json.type'],
            'ip v4 valid'                             => [V\Ip::class, [V\Ip::V4], '127.0.0.1'],
            'ip v6 invalid'                           => [V\Ip::class, [V\Ip::V6], '127.0.0.1', 'processing.guard.invalid_value.ip'],
            ...
            'bic invalid'                             => [V\Bic::class, [], 'INVALID', 'processing.guard.invalid_value.bic'],
            'card scheme visa valid'                  => [V\CardScheme::class, ['visa'], '4111111111111111'],
            'card scheme invalid'                     => [V\CardScheme::class, ['visa'], '1234', 'processing.guard.invalid_value.card_scheme'],
            ...
            'currency invalid'                        => [V\Currency::class, [], 'US', 'processing.guard.invalid_value.currency'],
            'luhn valid'                              => [V\Luhn::class, [], '79927398713'],
            'luhn invalid'                            => [V\Luhn::class, [], '79927398714', 'processing.guard.invalid_value.luhn'],
            'iban valid'                              => [V\Iban::class, [], 'GB82WEST12345698765432'],
            'iban invalid'                            => [V\Iban::class, [], 'GB82WEST12345698765433', 'processing.guard.invalid_value.iban'],
            ...
            'iban invalid length'                     => [V\Iban::class, [], 'GB82WEST123', 'processing.guard.invalid_value.iban'],
            'iban invalid format'                     => [V\Iban::class, [], 'GB82WEST12345698$%432', 'processing.guard.invalid_value.iban'],
            'iban country mismatch'                   => [V\Iban::class, ['DE'], 'GB82WEST12345698765432', 'processing.guard.invalid_value.iban'],
            'isbn valid'                              => [V\Isbn::class, [], '0-306-40615-2'],
            'isbn invalid'                            => [V\Isbn::class, [], '0-306-40615-3', 'processing.guard.invalid_value.isbn'],
            'isbn invalid length'                     => [V\Isbn::class, [], '123', 'processing.guard.invalid_value.isbn'],
            ...
            'issn invalid'                            => [V\Issn::class, [], '0378-5956', 'processing.guard.invalid_value.issn'],
            'issn invalid format'                     => [V\Issn::class, [], '12345-67A', 'processing.guard.invalid_value.issn'],
            'luhn non-digit invalid'                  => [V\Luhn::class, [], '----', 'processing.guard.invalid_value.luhn'],
            ...
            'enum backed value invalid instance'      => [V\EnumBackedValue::class, [DummyStatus::class], DummyStatus::Draft, 'processing.guard.expected'],
            'enum backed value invalid value'         => [V\EnumBackedValue::class, [DummyStatus::class], 'nope', 'processing.guard.expected'],
            ...
            'enum case invalid string'                => [V\EnumCase::class, [DummyStatus::class], 'archived', 'processing.guard.invalid_value.enum.case'],
            ...
            'compare to failed'                       => [V\CompareTo::class, ['==', 5], 6, 'processing.guard.invalid_value.compare_to'],
            ...
            'compare to invalid datetime string'      => [V\CompareTo::class, ['==', new \DateTimeImmutable('2020-01-01')], 'not-a-date', 'processing.guard.invalid_value.compare_to.datetime'],
            ...
            'equals strict invalid'                   => [V\Equals::class, [5, true], '5', 'processing.guard.expected.equals'],
            ...
            'in invalid'                              => [V\In::class, [['yes', 'no']], 'maybe', 'processing.guard.invalid_value.not_in'],
            ...
            'instance of invalid'                     => [V\IsInstanceOf::class, [\stdClass::class], 'nope', 'processing.guard.expected.instance_of'],
            ...
            'is numeric string invalid'               => [V\IsNumericString::class, [], 123, 'processing.guard.expected'],
            ...
            'is blank false countable'                => [V\IsBlank::class, [false], new \ArrayObject([]), 'processing.guard.expected'],
            'is blank false iterable'                 => [V\IsBlank::class, [false], self::nonEmptyIterator()],
            'is blank true int zero invalid'          => [V\IsBlank::class, [true], 0, 'processing.guard.expected'],
            'is blank true zero invalid'              => [V\IsBlank::class, [true], '0', 'processing.guard.expected'],
            'is blank false invalid'                  => [V\IsBlank::class, [false], '   ', 'processing.guard.expected'],
            ...
            'is null false invalid'                   => [V\IsNull::class, [false], null, 'processing.guard.expected'],
            ...
            'length array too short'                  => [V\Length::class, ['min' => 3], ['a'], 'processing.guard.array_length.below_min'],
            ...
            'length too long'                         => [V\Length::class, ['min' => 2, 'max' => 6], 'abcdefgh', 'processing.guard.string_length.above_max'],
            'length too short'                        => [V\Length::class, ['min' => 2, 'max' => 6], 'a', 'processing.guard.string_length.below_min'],
            ...
            'uuid invalid'                            => [V\Uuid::class, [], 'not-a-uuid', 'processing.guard.invalid_value.uuid'],
            ...
            'in json encode failure'                  => [V\In::class, [self::resourceList()], 'nope', 'processing.guard.invalid_value.not_in'],
        ];
    }
