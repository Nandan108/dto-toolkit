...
final class BuiltInValidatorClassesTest extends TestCase
{
    ...
    {
        // Note: Keep this list in alphabetical order by test case key, for easier maintenance.
        // Keys should start with the validator name for easier searching, and be descriptive of the test case.
        return [
            ...
            'enum backed value invalid type'          => [V\EnumBackedValue::class, [DummyStatus::class], new \stdClass(), 'Expected a string or an integer, got stdClass.'],
            ...
            'enum backed value non scalar type'       => [V\EnumBackedValue::class, [DummyStatus::class], [], 'Expected a string or an integer, got an array.'],
            'enum backed value valid'                 => [V\EnumBackedValue::class, [DummyStatus::class], 'draft'],
            'enum case backed invalid type'           => [V\EnumCase::class, [DummyStatus::class], new \stdClass(), 'test{Assert\EnumCase}: Expected a string or an integer, got stdClass.'],
            'enum case invalid backed name'           => [V\EnumCase::class, [DummyStatus::class], 'Draft', 'Invalid enum case.'],
            ...
            'enum case invalid unit name'             => [V\EnumCase::class, [DummyUnitStatus::class], 'Gamma', 'Invalid enum case.'],
            'enum case invalid unit non-string'       => [V\EnumCase::class, [DummyUnitStatus::class], 1, 'Expected a string, got an integer.'],
            ...
            'enum case valid unit instance'           => [V\EnumCase::class, [DummyUnitStatus::class], DummyUnitStatus::Alpha],
            'enum case valid unit name'               => [V\EnumCase::class, [DummyUnitStatus::class], 'Alpha'],
            ...
            'length countable too short'              => [V\Length::class, ['min' => 3], new \ArrayObject(['a']), 'Array must contain at least'],
            ...
            'length not supported type'               => [V\Length::class, ['min' => 2, 'max' => 6], 12345, 'Expected a string, an array, or a countable, got an integer.'],
            'length on array'                         => [V\Length::class, ['min' => 2, 'max' => 3], ['a', 'b'], null],
            'length on countable'                     => [V\Length::class, ['min' => 2, 'max' => 3], new \ArrayObject(['a', 'b']), null],
